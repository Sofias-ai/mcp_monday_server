    ...
    async def handle_call_tool(name, arguments):
        try:
            if name == "Get_Board_Schema":
                ...
                result = {
                    "board_info": {"id": MONDAY_BOARD_ID, "name": board_data["data"]["boards"][0]["name"]},
                ...
                response = monday_client.items.fetch_items_by_id(item_id)
                ...
                response = monday_client.items.fetch_items_by_column_value(MONDAY_BOARD_ID, column_id, column_value)
